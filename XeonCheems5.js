...
teks = `*「 ${global.botname} Script 」*\n\nBanh Dims: ${global.websitex}\nGitHub: ${global.botscript}\n\nDont forget to donate 🍜`
let buttons = [
{buttonId: `owner`, buttonText: {displayText: 'Owner 🌺'}, type: 1}
]
let buttonMessage = {
image: {url: `https://foot.wiki/donatebanhdims.php?id=B4YBQE.com`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
...
mediaType:1,
mediaUrl: 'https://foot.wiki/donatebanhdims.php?id=B4YBQE.com',
sourceUrl: "https://foot.wiki/donatebanhdims.php?id=B4YBQE.com"
}}
}
 ...
 break
	...
	const sections = [{
								...
								"rows": [
									{
										"title": "『DIMAS BOTZZ』",
										"description": "Jangan Lupa Donasi Ke Banh Dims Ya Kak 🥺",
							...
							},
							{
								...
								"rows": [
									...
									{
										"title": "Menu Download ↘️",
										"description": "Ingin Download Sesuatu Kak?🤔",
										"rowId": `${prefix}downloadmenu`
									},
									{
										"title": "Sticker Menu 🃏",
										"description": "Ingin Membuat Stiker?",
										"rowId": `${prefix}stickermenu`
									},
									{
										"title": "Search Menu 🔎",
										"description": "Ayo Mencari Sesuatu Bersama Dimas Bot",
